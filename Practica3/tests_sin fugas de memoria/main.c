        ...
        switch (opcion) {
            ...
            case 2: { // Insert
                if (!tablaSeleccionada) {
                    ...
                    book_id[4] = '\0';     // Asegurar terminación en nulo
                    ...
                    nuevoLibro.book_id[4] = '\0'; // Asegurar terminación en nulo
